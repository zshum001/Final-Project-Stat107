...
Variable columns 3-12 will be renamed as follows to enhance clarity:
...
From graphing a histogram, it is obvious that outlines exist. We will use the variable S_CO as a starting point for tidying up the data. We will use the IQR method to identify outliers and filter them out of the dataset.
