...
airM %>%
  ...
  geom_line(aes(y = S_NMHC, color = "Non-Methane Hydrocarbon", group = 1)) +
  geom_point(aes(y = S_NOx, color = "Nitrogen Oxide")) + 
  geom_line(aes(y = S_NOx, color = "Nitrogen Oxide", group = 1)) +
  geom_point(aes(y = S_NO2, color = "Nitrogen Dioxide")) + 
  geom_line(aes(y = S_NO2, color = "Nitrogen Dioxide", group = 1)) +
  geom_point(aes(y = S_O3, color = "Ozone")) + 
  geom_line(aes(y = S_O3, color = "Ozone", group = 1)) +
  labs(
