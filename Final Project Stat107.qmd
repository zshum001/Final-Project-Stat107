...
pollutants <- c('CO.GT.', 'PT08.S1.CO.', 'NMHC.GT.', 'C6H6.GT.', 'PT08.S2.NMHC.',
                'NOx.GT.', 'PT08.S3.NOx.', 'NO2.GT.', 'PT08.S4.NO2.', 'PT08.S5.O3.')

# Loop over pollutants and create plots dynamically
for (pollutant in pollutants) {
  
  # Clean data for the specific pollutant: Remove NA and negative values
  airM_clean <- air %>%
    filter(!is.na(!!sym(pollutant)) & !!sym(pollutant) >= 0) %>%
    group_by(Date) %>% 
    summarise(avg_pollutant = mean(!!sym(pollutant), na.rm = TRUE))
  
  # Create the plot for the pollutant
  ggplot(airM_clean, aes(x = Date, y = avg_pollutant)) +
    geom_point() +
    geom_line(group = 1) +
    labs(title = paste("Average concentration of", pollutant, "by Month"),
         x = "Date", y = paste("[", pollutant, "] in µg/m³", sep = "")) +
...
#Create plot for PT08.S1.CO.
ggplot(airM_clean, aes(x = Date, y = `C6H6.GT.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of C6H6.GT. by Month", x = "Date", y = "[C6H6] in µg/m³") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
#Create plot for PT08.S2.NMHC.
ggplot(airM_clean, aes(x = Date, y = `PT08.S2.NMHC.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of PT08.S2.NMHC. by Month", x = "Date", y = "PT08.S2(NMHC)") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
#Create plot for NOx.GT.
ggplot(airM_clean, aes(x = Date, y = `NOx.GT.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of NOx.GT. by Month", x = "Date", y = "[NOx] in µg/m³") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
#Create plot for PT08.S3.NOx.
ggplot(airM_clean, aes(x = Date, y = `PT08.S3.NOx.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of PT08.S3.NOx. by Month", x = "Date", y = "PT08.S3.NOx.") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
#Create plot for PT08.S1.CO.
ggplot(airM_clean, aes(x = Date, y = `NO2.GT.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of NO2.GT. by Month", x = "Date", y = "[NO2] in µg/m³") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
#Create plot for PT08.S4.NO2.
ggplot(airM_clean, aes(x = Date, y = `PT08.S4.NO2.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of PT08.S4.NO2. by Month", x = "Date", y = "PT08.S4.NO2.") + theme(axis.text.x = element_text(angle = 45, hjust = 1))

### Average Concentration of PT08.S5(O3) by Month
...
#Create plot for PT08.S5.O3.
ggplot(airM_clean, aes(x = Date, y = `PT08.S5.O3.`)) + geom_point() + geom_line(group = 1) + labs(title = "Average concentration of PT08.S5.O3. by Month", x = "Date", y = "PT08.S5.O3.") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
